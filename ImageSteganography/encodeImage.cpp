...
int main(int argc, char** argv)
{
    ...
    image1 = imread("G:\\C++\\opencv\\images\\lena.jpg", IMREAD_COLOR);
    image2 = imread("G:\\C++\\opencv\\images\\2.jpg", IMREAD_COLOR);
    ...
    imwrite("G:\\C++\\opencv\\images\\staged-lena.jpg", image3);
    waitKey(0);
